...
#    | $$| $$_____/| $$      | $$  | $$ /$$/\  $$      | $$  | $$| $$  | $$| $$  | $$ /$$  \ $$
#    | $$|  $$$$$$$|  $$$$$$$| $$  | $$| $$  \ $$      | $$$$$$$/| $$$$$$$/|  $$$$$$/|  $$$$$$/
#    |__/ \_______/ \_______/|__/  |__/|__/  |__/      |_______/ |_______/  \______/  \______/ 
#++++++++++++++++++++++++++++++++++++++++++++++++++++++
# AUTHOR : ToolsX | MrTechX | UlisesCamacho
# PROJECT :TechX DDoS | TERMUX 
# VERSION : 1.0.0
#++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   ******@@@@@@@@@@@*****@@@@@@@@@ 
   ...
   @@@@@***@@@@@@@@******@@@@@@@@@ 
    ,@@@***@@@@@@   ,@@@@@@@@@@@   
         **@@@@@@   @@@@@@@        
              @@@   @@@            
 _______        _    __   __  _____  _____        _____ 
|__   __|      | |   \ \ / / |  __ \|  __ \      / ____|
   | | ___  ___| |__  \ V /  | |  | | |  | | ___| (___  
   | |/ _ \/ __| '_ \  > <   | |  | | |  | |/ _ \\___ \ 
   | |  __/ (__| | | |/ . \  | |__| | |__| | (_) |___) |
   |_|\___|\___|_| |_/_/ \_\ |_____/|_____/ \___/_____/                                                         
        '''+Style.RESET_ALL+Fore.GREEN+Style.BRIGHT+'''
by:MrTechX | ToolsX | UlisesCamacho  
    ...
    try:
        ...
        for i in tqdm(range(30000)):
            print(end=Fore.RED+Style.BRIGHT+'\r')
